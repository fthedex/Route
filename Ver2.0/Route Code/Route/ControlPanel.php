...
<head>
	...
	if($globalUser->getUserType()=="4")
	{
		include("adminHeadScripts.php");
	}
        else if($globalUser->getUserType()=="1"){ //driver , we echo his map function , should accept markers (dynamic) soon to be developped
...
<div style="padding:0px;" class="loginBody container-fluid">
    ...
    }else if($globalUser->getUserType()=="4"){
