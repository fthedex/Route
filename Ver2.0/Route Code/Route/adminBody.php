...
<div class='loginBody container-fluid padding20'>
	...
	<div id='studentParentForm' class='forms' style='border: 2px white solid;' width='40%'>
            <h2 align='center'> Student Parent Form</h2>
            <form  name='studentParentForm' method='post' enctype='multipart/form-data'>
                StudentID: <br>
                <input required type='text' name='sp_studentid' id='sp_studentid'>
                <br>
                parentID: <br>
                <input required type='text' name='sp_parentid' id='sp_parentid'>
                <br><br>
                <input type='submit' value='Submit' id='studentParentSubmit' class='submitStudentParentForm'>
            </form>
        </div>
